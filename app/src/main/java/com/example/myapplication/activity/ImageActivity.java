...
//    }
    ...
    private void getUserAvatar() {
        Long personId = Long.valueOf(AppService.getPerson().getId());
        ...
        Call<ApiResult> result = userImageService.getUserImage(AppService.getToken(), personId);   // call method interfacenya
...
//                    openUserAddressFragment();
    ...
    public void openUserImageFragment() {
        ...
        ImageFragment strCode = new ImageFragment();
    ...
    private void getUserAddressData() {
        ...
        String personId = String.valueOf(AppService.getPerson().getId());

        UserAddressService userAddressService = retrofit.create(UserAddressService.class);
        Call<ApiResult> resultCall = userAddressService.getAddressById(AppService.getToken(), personId);
...
//                Toasty.error(getBaseContext(), t.getMessage(), Toasty.LENGTH_LONG).show();
                Toast.makeText(ImageActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
    ...
    public void openUserAddressDataFragment() {
        ...
        FragmentManager fragmentManager = getSupportFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        AddressDataFragment strCode = new AddressDataFragment();
        fragmentTransaction.replace(R.id.content, strCode, "userAddressFragmentData");
        fragmentTransaction.commit();
    }
...
//                Log.e(TAG, "onFailure: " + t);
////                Toasty.error(getBaseContext(), t.getMessage(), Toasty.LENGTH_LONG).show();
//                Toasty.error(UserSettingActivity.this, t.getMessage(), Toasty.LENGTH_LONG).show();
